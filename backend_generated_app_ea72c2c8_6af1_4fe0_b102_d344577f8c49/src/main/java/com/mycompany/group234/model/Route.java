...
public class Route {
  ...
  @Column(name = "\"StartsAt\"", nullable = true )
  ...
  @Column(name = "\"TotalDistanceCovered\"", nullable = true )
  private Integer totalDistanceCovered;
  
	  
  @Column(name = "\"NumberOfStops\"", nullable = true )
